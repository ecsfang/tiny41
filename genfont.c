...
int main(int argv, char *argc[])
{
    ...
    printf(" * font41.h\n");
    printf(" *\n");
    printf(" * Do not edit! This file is automatically generated by genfont.\n");
    printf(" *\n");
    printf(" * This file is part of the Tiny41 HP41/Pico project.\n");
    printf(" * Copyright (C) 2023 Thomas Fänge <ecsfang@hotmail.com>\n");
    printf(" *\n");
