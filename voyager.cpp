...
// Defines the address to the main routine in
// each calculator

const uint32_t voyMain[6] = {
  0x00,                  // None
  MANT(VOY_PORT(0x39)),  // HP10C
  MANT(VOY_PORT(0x00)),  // HP11C
  MANT(VOY_PORT(0x00)),  // HP12C
  MANT(VOY_PORT(0x96)),  // HP15C
  MANT(VOY_PORT(0x89))   // HP16C
}; 
...
// The mapping of keys between the Voyager and the HP41
